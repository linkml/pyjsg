...
from pyjsg.parser_impl.jsg_arrayexpr_parser import JSGArrayExpr, BELOW_314
...
def test_options():
    ...
    if BELOW_314:
        ...
        check(t,
              ('arrayExpr: [valueType: (Undefined(objectValue) | Undefined(LanguageStem))+]',
               'list[Undefined(LanguageStem) | Undefined(objectValue)]',
               ['objectValue', 'LanguageStem'],
               "jsg.ArrayFactory('{name}', _CONTEXT, typing.Union[Undefined(objectValue), Undefined(LanguageStem)], 1, None)",
               'None',
               [])
    ...
    if BELOW_314:
        ...
        check(t,
              ('arrayExpr: [(valueType: ID: objectValue | valueType: ID: '
               ...
               'list[Undefined(languageStem) | Undefined(objectValue)]',
               ['objectValue', 'languageStem'],
               "jsg.ArrayFactory('{name}', _CONTEXT, Undefined(languageStem) | Undefined(objectValue), 3, 7)",
               'None',
               [])
              )
